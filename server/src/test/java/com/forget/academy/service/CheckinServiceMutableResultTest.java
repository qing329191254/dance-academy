...
class CheckinServiceMutableResultTest {
    ...
    void setUp() {
        service = new CheckinService(
                practiceRecordRepo, scheduleRepo, new ObjectMapper(), userCampusService, userCardService);
    }
    ...
    void manualCheckin_returnsMutableMap_soCallerCanOverwriteMessage() {
        ...
        when(scheduleRepo.findById(55L)).thenReturn(java.util.Optional.of(schedule));
